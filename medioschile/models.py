...
class Propietario(models.Model):
	...
	presidentedirectorio = models.ForeignKey(Empresario, related_name="propietario_presidentedirectorio", verbose_name="Controlador/Presidente Directorio", null=True, blank=True)
...
class PorcentajePropietario(models.Model):
	...
	socioporcentaje = models.ForeignKey(Sociedad, verbose_name="Socio", related_name="socio_porcentajep", null=True, blank=True)
	porcentajesocio = models.IntegerField("Porcentaje", null=True, blank=True)
	fechaporcentaje = models.DateField("Fecha", null=True, blank=True)
	fuenteporcentajesocio = models.ForeignKey(Fuente, verbose_name="Fuente", null=True, blank=True)
	propietarioporcentaje = models.ForeignKey(Propietario, null=True, blank=True)
...
class Escrito(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Región", null=True, blank=True)
	comuna = select2.fields.ManyToManyField(Comuna, verbose_name="Comuna", null=True, blank=True, help_text="Actualice con F5 - Si el medio tiene cobertura regional, no es necesario ingresar las comunas.")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Ciudad", null=True, blank=True, help_text="Actualice con F5 - Si ingresa la(s) comuna(s) correspondientes, no es necesario señalar la(s) ciudad(es).")
...
class Radio(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Región", related_name="radio_region", null=True, blank=True)
	comuna = select2.fields.ManyToManyField(Comuna, verbose_name="Comuna", null=True, blank=True, help_text="Actualice con F5 - Si el medio tiene cobertura regional, no es necesario ingresar las comunas.")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Ciudad", related_name="radio_ciudad", null=True, blank=True, help_text="Actualice con F5 - Si ingresa la(s) comuna(s) correspondientes, no es necesario señalar la(s) ciudad(es).")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Comuna-Ciudad")
	sitioweb = models.URLField("Sitio WEB", max_length=255, null=True, blank=True, help_text="http://...")
...
class CanalTV(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Región", related_name="canaltv_region", null=True, blank=True)
	comuna = select2.fields.ManyToManyField(Comuna, verbose_name="Comuna", null=True, blank=True, help_text="Actualice con F5 - Si el medio tiene cobertura regional, no es necesario ingresar las comunas.")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Ciudad", related_name="canaltv_ciudad", null=True, blank=True, help_text="Actualice con F5 - Si ingresa la(s) comuna(s) correspondientes, no es necesario señalar la(s) ciudad(es).")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Comuna-Ciudad")
	sitioweb = models.URLField("Sitio WEB", max_length=255, null=True, blank=True, help_text="http://...")
...
class MedioDigital(models.Model):
	...
	region = select2.fields.ManyToManyField(Region, verbose_name="Región", related_name="mediodigital_region", null=True, blank=True)
	comuna = select2.fields.ManyToManyField(Comuna, verbose_name="Comuna", null=True, blank=True, help_text="Actualice con F5 - Si el medio tiene cobertura regional, no es necesario ingresar las comunas.")
	ciudad = select2.fields.ManyToManyField(Ciudad, verbose_name="Ciudad", related_name="mediodigital_ciudad", null=True, blank=True, help_text="Actualice con F5 - Si ingresa la(s) comuna(s) correspondientes, no es necesario señalar la(s) ciudad(es).")
	direccion = models.CharField("Dirección", max_length=255, blank=True, help_text="Calle-Nº-Comuna-Ciudad")
